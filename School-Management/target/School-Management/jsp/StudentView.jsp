...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<%=SCMView.STUDENT_CTL%>" method="post" >
        
       <jsp:useBean id="bean" class="in.co.school.mgt.bean.StudentBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Student</h3>
                		...
                		<div class="form-row">
        					...
        					<div class="form-group col-md-6">
								<input type="text" class="form-control"  name="fatherName"
									placeholder="Father Name" value="<%=DataUtility.getStringData(bean.getFatherName())%>" > 
									<font  color="red"><%=ServletUtility.getErrorMessage("fatherName", request)%></font>
							</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="text" class="form-control"  name="bloodGroup"
									...
									<font  color="red"><%=ServletUtility.getErrorMessage("bloodGroup", request)%></font>
							</div>
        					...
        					<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=StudentCtl.OP_SAVE%>">&nbsp;or&nbsp;
								<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=StudentCtl.OP_RESET%>">
        </form>
    </div>
</div>
</div> </div> <!--feedback-->
