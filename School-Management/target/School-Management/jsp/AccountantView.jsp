<%@page import="in.co.school.mgt.controller.AccountantCtl"%>
<%@page import="in.co.school.mgt.controller.FacultyCtl"%>
...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<%=SCMView.ACCOUNTANT_CTL%>" method="post" >
        
       <jsp:useBean id="bean" class="in.co.school.mgt.bean.AccountantBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Accountant</h3>
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
                		...
                		<div class="form-group">
							...
							<div class="form-group">
                   				 <textarea class="form-control" type="textarea" name="qualification" placeholder="Qualification"  rows="3"><%=DataUtility.getStringData(bean.getQualification())%></textarea>
        					...
        					<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=AccountantCtl.OP_SAVE%>">&nbsp;or&nbsp;
								<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=AccountantCtl.OP_RESET%>">
        </form>
    </div>
</div>
</div> </div> <!--feedback-->
