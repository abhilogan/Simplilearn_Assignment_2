...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<%=SCMView.FACULTY_CTL%>" method="post" >
        
       <jsp:useBean id="bean" class="in.co.school.mgt.bean.FacultyBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Faculty</h3>
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
                		...
                		<div class="form-group">
        					...
        					<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=FacultyCtl.OP_SAVE%>">&nbsp;or&nbsp;
								<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=FacultyCtl.OP_RESET%>">
        </form>
    </div>
</div>
</div> </div> <!--feedback-->
