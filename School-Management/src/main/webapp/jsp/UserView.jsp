<%@page import="in.co.school.mgt.controller.UserCtl"%>
...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<%=SCMView.USER_CTL%>" method="post" >
       ...
       <jsp:useBean id="bean" class="in.co.school.mgt.bean.UserBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Update User</h3>
