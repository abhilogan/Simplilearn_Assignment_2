<%@page import="in.co.school.mgt.model.FacultyModel"%>
<%@page import="in.co.school.mgt.controller.StudentCtl"%>
<%@page import="in.co.school.mgt.util.DataUtility"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.co.school.mgt.bean.FacultyBean"%>
<%@page import="in.co.school.mgt.controller.FacultyListCtl"%>
...
<%@ include file="Header.jsp"%>
	...
	<form action="<%=SCMView.FACULTY_LIST_CTL%>" method="post">
		<div id="feedback">
			<div class="container">
				<div class="col-md-9">
					<div class="form-area">

						<h3 style="margin-bottom: 15px; text-align: left;">Faculty
							List</h3>
						<div class="form-row">
							...
							<div class="form-group col-lg-4">
								<input type="submit" name="operation"
									...
									value="<%=FacultyListCtl.OP_SEARCH%>">&nbsp;or&nbsp; <input
			...
			<tbody>
				...
				<tr>
					...
					<td><a class="btn btn-primary pull-right"
						href="faculty?id=<%=bean.getId()%>">Edit</a></td>
				</tr>
		...
		<table width="99%" style="bottom: 45px">
			<tr>
				...
				<td align="right"><input type="submit" name="operation"
					class="btn btn-primary pull-right" value="<%=FacultyListCtl.OP_NEXT%>"
