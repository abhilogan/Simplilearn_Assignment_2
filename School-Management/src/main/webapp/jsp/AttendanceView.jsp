<%@page import="in.co.school.mgt.controller.AttendanceCtl"%>
...
<div col-md-5img-thumbnail">
		<div id="feedback">
			<div class="container">
				<div class="col-md-5">
					<div class="form-area">
						<form role="form" action="<%=SCMView.ATTENDANCE_CTL%>" method="post" >
							<br style="clear: both">
		
							<jsp:useBean id="bean" class="in.co.school.mgt.bean.AttendanceBean"
             ...
             <input type="hidden" name="id" value="<%=bean.getId()%>">
              ...
              <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
							...
							<h3 style="margin-bottom: 15px; text-align: left: ;">Add Attendance</h3>
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
							...
							<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=AttendanceCtl.OP_SAVE %>">
								<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=AttendanceCtl.OP_RESET %>">
						</form>
					</div>
				</div>
			</div>
