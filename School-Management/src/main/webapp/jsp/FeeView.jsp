<%@page import="in.co.school.mgt.controller.FeeCtl"%>
...
<div col-md-5img-thumbnail">
		<div id="feedback">
			<div class="container">
				<div class="col-md-5">
					<div class="form-area">
						<form role="form" action="<%=SCMView.FEE_CTL%>" method="post" >
							<br style="clear: both">
		
							<jsp:useBean id="bean" class="in.co.school.mgt.bean.FeeBean"
             ...
             <input type="hidden" name="id" value="<%=bean.getId()%>">
              ...
              <input type="hidden" name="modifiedDatetime" value="<%=DataUtility.getTimestamp(bean.getModifiedDatetime())%>">
							...
							<h3 style="margin-bottom: 15px; text-align: left: ;">Add Fee</h3>
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control"  name="pay"
									placeholder="Pay Amount" value="<%=(bean.getPay()!=0)?bean.getPay():""%>" > 
