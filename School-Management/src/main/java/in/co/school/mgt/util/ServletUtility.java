...
import in.co.school.mgt.controller.BaseCtl;
import in.co.school.mgt.controller.SCMView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(SCMView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
