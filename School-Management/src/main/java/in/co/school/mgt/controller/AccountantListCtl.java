...
/**
 * Servlet implementation class AccountantListCtl
 */
@WebServlet(name = "AccountantListCtl", urlPatterns = { "/ctl/accountantList" })
public class AccountantListCtl extends BaseCtl {
	private static final long serialVersionUID = 1L;
       
	private static Logger log = Logger.getLogger(AccountantListCtl.class);

	@Override
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("AccountantListCtl populateBean method start");
		...
		log.debug("AccountantListCtl populateBean method end");
		return bean;
	}
	/**
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("AccountantListCtl doGet Start");
		List list = null;
		...
		log.debug("AccountantListCtl doPOst End");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		log.debug("AccountantListCtl doPost Start");
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				if (ids != null && ids.length > 0) {
					AccountantBean deletebean = new AccountantBean();
					for (String id : ids) {
		...
		log.debug("AccountantListCtl doGet End");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return SCMView.ACCOUNTANT_LIST_VIEW;
	}
